...
if len(sys.argv) < 2 :
    print ('[source path] [oss object key]')
    exit()
...
# 分别以HTTP、HTTPS协议访问。
access_key_id = os.getenv('OSS_TEST_ACCESS_KEY_ID', '<AccessKeyId>') # <你的AccessKeyId>
access_key_secret = os.getenv('OSS_TEST_ACCESS_KEY_SECRET', '<AccessKeySecret>') # 你的AccessKeySecret
bucket_name = os.getenv('OSS_TEST_BUCKET', 'app-download') # <你的Bucket>
